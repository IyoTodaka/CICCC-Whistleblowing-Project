            ...
            <table className="w-full text-sm text-left text-gray-500 table-fixed">
                <thead className="text-sm md:text-base text-center text-gray-700 bg-gray-200 ">
                    <tr>
                        ...
                        <th onClick={() => setRoleSort(!roleSort)} scope="col" className="px-3 py-2  md:py-3 w-40">
                        <div className='flex items-center justify-center'>
                            Role
                            {roleSort? upArrow: downArrow}
                        </div>                          
                        </th>
                        <th onClick={() => setNameSort(!nameSort)} scope="col" className="px-3 py-2  md:py-3 w-56">
                        <div className='flex items-center justify-center'>
                            Name
                ...
                {agentList.length > 0 && 
                    agentList.map(eachAgent => (
                        <tr className="bg-white border-b text-gray-900 text-center" key={eachAgent._id}>
