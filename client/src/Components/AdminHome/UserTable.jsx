...
const UserTable = ({ setIsDetailOpen }) => {
    ...
    const handleClick = (eachUser) => {
        open()
        dispatch(setUserDetail(eachUser))
    }
            ...
            <table className="w-full text-sm text-left text-gray-500 table-fixed">
                <thead className="text-sm md:text-base text-center text-gray-700 bg-gray-200 ">
                    <tr>
                        ...
                        <th onClick={() => setDepartmentSort(!departmentSort)} scope="col" className="cursor-pointer px-3 py-2  md:py-3 w-40 hover:bg-gray-300">
                            <div className='flex items-center justify-center'>
                                Department
                        ...
                        <th onClick={() => setLastPostedSort(!lastPostedSort)} scope="col" className="cursor-pointer px-3 py-2  md:py-3 w-40 hover:bg-gray-300">
                            <div className='flex items-center justify-center'>
                                Posted
                ...
                {userInfo.length > 0 && 
                    userInfo.map(eachUser => (
                        <tr className="bg-white border-b text-gray-900 text-center cursor-pointer hover:bg-gray-100" key={eachUser._id} onClick={() => handleClick(eachUser)}>
