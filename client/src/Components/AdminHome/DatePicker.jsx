    ...
    <div className="w-full">
      <div className="relative">
        <input
          type="text"
          readOnly
          className="cursor-pointer w-full pl-3 pr-10 py-2 leading-none shadow appearance-none border rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 "
